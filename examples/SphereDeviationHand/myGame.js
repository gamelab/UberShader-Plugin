...
loader.preload = function () {
    ...
    * Load assets
    **/
    this.addImage( 'background', '../assets/oceanBlur.png' );

    this.addImage( 'black', '../assets/black.png' );
    this.addImage( 'reflectionMap', '../assets/Sphere_Ocean_ref.png' );
    this.addImage( 'irradianceMap', '../assets/Sphere_Ocean_irr.png' );
