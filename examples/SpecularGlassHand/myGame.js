...
loader.preload = function () {
    ...
    **/
    ...
    this.addImage( 'handDiff', '../assets/ZachHandGlass_diff.png' );
    this.addImage( 'handNorm', '../assets/ZachHand1_normSharp.png' );
    this.addImage( 'handSpec', '../assets/ZachHand1_specGlass.png' );
    this.addImage( 'handSpecMetal', '../assets/ZachHand1_specMetal.png' );
