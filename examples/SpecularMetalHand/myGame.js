...
loader.preload = function () {
    ...
    **/
    ...
    this.addImage( 'reflectionMap', '../assets/SphereMap_mydesk.png' );
    this.addImage( 'irradianceMap', '../assets/SphereMap_mydesk_irradiance.png' );

    // Load multitexture assets
    this.addImage( 'handDiff', '../assets/ZachHandYellow_diff.png' );
    this.addImage( 'handNorm', '../assets/ZachHand1_normSharp.png' );
    this.addImage( 'handSpec', '../assets/ZachHandPlastic_spec.png' );
    this.addImage( 'handSpecMetal', '../assets/ZachHandMetal_spec.png' );
