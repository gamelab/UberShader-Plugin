...
var loader = new KiwiLoadingScreen('loader', 'state', '../assets/img/loading/');
...
loader.preload = function () {
    ...
    * Load assets
    **/
    this.addImage( 'background', '../assets/mydesk_blur.png' );
    this.addImage( 'background2', '../assets/oceanBlur.png' );
    this.addImage( 'background3', '../assets/oceanSunsetBlur.png' );

    this.addImage( 'black', '../assets/black.png' );
    this.addImage( 'reflectionMap1', '../assets/SphereMap_mydesk.png' );
    this.addImage( 'irradianceMap1', '../assets/SphereMap_mydesk_irradiance.png' );
    this.addImage( 'reflectionMap2', '../assets/Sphere_Ocean_ref.png' );
    this.addImage( 'irradianceMap2', '../assets/Sphere_Ocean_irr.png' );
    this.addImage( 'reflectionMap3', '../assets/Sphere_Ocean_Sunset_ref.png' );
    this.addImage( 'irradianceMap3', '../assets/Sphere_Ocean_Sunset_irr.png' );

    // Load multitexture assets
    this.addImage( 'handDiff', '../assets/ZachHand1_diff.png' );
    this.addImage( 'handNorm', '../assets/ZachHand1_norm.png' );
    this.addImage( 'handSpec', '../assets/ZachHand1_spec.png' );
    this.addImage( 'handEmit', '../assets/ZachHand1_emit.png' );
    this.addImage( 'handTint', '../assets/ZachHand1_tint.png' );
